...
public class Problem5 { //class
	...
	public static String noYak(String x) {
		...
		if (index < length) { //check if index is less than length
		answer = x.substring(0, index) + x.substring(index + 3); //if true, answer equals the substring of x from 0 to the index and the substring of x from the index + 3
		}
